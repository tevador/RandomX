...
RANDOMX_ARGON_SALT TEXTEQU <"RandomX-TOR-v1">
RANDOMX_CACHE_ACCESSES EQU 4t
RANDOMX_SUPERSCALAR_LATENCY EQU 170t
RANDOMX_DATASET_BASE_SIZE EQU 1073741824t
RANDOMX_DATASET_EXTRA_SIZE EQU 16777216t
RANDOMX_PROGRAM_SIZE EQU 256t
RANDOMX_PROGRAM_ITERATIONS EQU 2048t
RANDOMX_PROGRAM_COUNT EQU 2t
